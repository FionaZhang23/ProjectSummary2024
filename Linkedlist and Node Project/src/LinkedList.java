...
public class LinkedList {
    ...
    public void swap(int index1, int index2) {
        ...
        Card firstRemoved = remove_from_index(index1);

        index2--;

        Card secondRemoved = remove_from_index(index2);

        insert_at_index(firstRemoved, index2);

        insert_at_index(secondRemoved, index1);
    }
